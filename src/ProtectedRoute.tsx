...
const ProtectedRoute = (data:any) => {
  ...
  function checkAuth(location:any){
    ...
    else if((role === null || role === undefined) && (location.pathname === '/main' || location.pathname === '/grouplist' || location.pathname === '/schedule' || location.pathname === '/adminTools'))return false
